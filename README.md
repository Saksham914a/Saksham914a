...
- 🛠️ **Exploring Software Tools** — Always tinkering with new tech and platforms
- 🤖 **Machine Learning** — Building intelligent models with Python
- 📊 **Data Analytics** — Turning raw data into meaningful insights
- 🔐 **Cyber Security** — Understanding modern security fundamentals
